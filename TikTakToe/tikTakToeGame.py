...
# user_Input_Name1 = input(Fore.BLACK + Back.LIGHTGREEN_EX+ "Player 0, Enter your name" + Style.RESET_ALL)
user_Input_Name1 = input("Player 0, Enter your name")
print()
print()
# user_Input_Name2 = input(Fore.BLACK + Back.LIGHTYELLOW_EX+ "Player X, Enter your name" + Style.RESET_ALL)
